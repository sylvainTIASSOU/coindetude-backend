...
import 'package:built_value/json_object.dart';
import 'package:coindetude_api/src/model/auth_response.dart';
import 'package:coindetude_api/src/model/forgot_password_request.dart';
import 'package:coindetude_api/src/model/http_validation_error.dart';
import 'package:coindetude_api/src/model/login_request.dart';
import 'package:coindetude_api/src/model/otp_sent_response.dart';
import 'package:coindetude_api/src/model/refresh_request.dart';
import 'package:coindetude_api/src/model/register_request.dart';
import 'package:coindetude_api/src/model/resend_otp_request.dart';
import 'package:coindetude_api/src/model/reset_password_request.dart';
import 'package:coindetude_api/src/model/token_pair.dart';
import 'package:coindetude_api/src/model/verify_otp_request.dart';
...
class AuthApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [OTPSentResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OTPSentResponse>> forgotPassword({ 
    ...
    OTPSentResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OTPSentResponse),
      ) as OTPSentResponse;
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> login({ 
    required LoginRequest loginRequest,
    String? xTrustedDevice,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'X-Trusted-Device': xTrustedDevice,
        ...?headers,
      },
      extra: <String, dynamic>{
        'secure': <Map<String, String>>[],
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenPair>> refresh({ 
    String? xRefreshToken,
    RefreshRequest? refreshRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [OTPSentResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OTPSentResponse>> register({ 
  ...
  /// Returns a [Future] containing a [Response] with a [OTPSentResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OTPSentResponse>> resendOtp({ 
    ...
    final _path = r'/api/v1/auth/resend-otp';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthResponse>> resetPassword({ 
  ...
  Future<Response<AuthResponse>> verifyOtp({ 
    ...
    try {
      const _type = FullType(VerifyOTPRequest);
      _bodyData = _serializers.serialize(verifyOTPRequest, specifiedType: _type);
